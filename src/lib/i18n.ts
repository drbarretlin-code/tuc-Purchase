...
如於執行流程有任何建議或疑慮之處，煩請回覆此 MAIL。`,
    ...
    'tabPaidMode': '付費版模式',
    'proUnlocked': '已解鎖 Pro',
    'qstashTodayUsage': 'QStash 今日用量',
    'nextResetIn': '距離下次重置:',
    'unitHours': '小時',
    'unitMinutes': '分',
    'monthlyEgress': '本月累計傳輸 (Egress)',
    'cycleReset': '週期重置:',
    'everyMonth': '每月',
    'dayOfOfMonth': '號',
    'remainingAbout': '剩餘約',
    'unitDaysSuffix': '天',
    'proQStashLimit': '專業版 QStash 上限',
    'proQStashLimitVal': '100,000+ 次 / 日',
    'proEgressLimit': '專業版 Egress 流量',
    'proEgressLimitVal': '250 GB / 月',
    'proTimeoutLimit': 'Vercel 逾時上限',
    'proTimeoutLimitVal': '300s (Pro Runtime)',
    'proAiPriority': 'AI 解析優先級',
    'proAiPriorityVal': 'Enterprise Quota',
    'execLimitLabel': '執行上限',
    'aiModelLabel': 'AI 模型',
    'detecting': '偵測中...',
    'waitingForTask': '等待任務啟動',
    'detectionFailed': '偵測失敗 (請檢查 Key)',
    'resetAndReparseSelected': '重置並解析選取的',
    'abortParsing': '終止排隊與解析',
    'queueStuckHint': '若長時間停滯，可能是雲端佇列逾時休眠。請圈選檔案並點擊上方「全部重新解析」改由本地強制處理。',
    'ultraMining': '深度挖掘 (Ultra-Mining)',
    'diagnoseReason': '診斷原因',
    'unitItems': '筆',
    'forceRefreshStats': '強制重新獲取最新統計',
    'sizeLimitTooltip': '可手動輸入要刪除的容量設定',
    'diagTitle': '系統健康度與診斷報告',
    'diagEnvCheck': '環境配置檢查',
    'diagQueueStatus': '背景佇列狀態',
    'diagDeadlockDetect': '潛在阻塞偵測',
    'diagNoDeadlock': '未發現顯著的背景死鎖現象',
    'diagAnalysis': '診斷分析與建議',
    'diagFix': '立即解鎖並重啟佇列',
    'diagStalled': '已停滯:',
    'diagMinutes': '分鐘',
    'diagStatus': '狀態:',
    'pushingToQueue': '正在將檔案推入雲端解析佇列...',
    'close': '關閉',
    'apiQuotaWarning': '⚠️ API 額度即將耗盡！系統將持續運作至完全用盡為止。',
    'rpmLabel': 'RPM (每分鐘):',
    'rpdLabel': 'RPD (今日):',
    'keyPoolLabel': '金鑰池',
    'unitKeys': '把',
    'syncingHints': '同步建議事項中...',
    'modelLabel': 'Model:'
  },
  'zh-CN': {
...
如于执行流程有任何建议或疑慮之处，烦请回复此 MAIL。`,
    ...
    'unitHours': '小时',
    'unitMinutes': '分',
    'monthlyEgress': '本月累计传输 (Egress)',
    'cycleReset': '周期重置:',
    'everyMonth': '每月',
    'dayOfOfMonth': '号',
    'remainingAbout': '剩余约',
    'unitDaysSuffix': '天',
    'proQStashLimit': '专业版 QStash 上限',
    'proQStashLimitVal': '100,000+ 次 / 日',
    'proEgressLimit': '专业版 Egress 流量',
    'proEgressLimitVal': '250 GB / 月',
    'proTimeoutLimit': 'Vercel 超时上限',
    'proTimeoutLimitVal': '300s (Pro Runtime)',
    'proAiPriority': 'AI 解析优先级',
    'proAiPriorityVal': 'Enterprise Quota',
    'execLimitLabel': '执行上限',
    'aiModelLabel': 'AI 模型',
    'detecting': '侦测中...',
    'waitingForTask': '等待任务启动',
    'detectionFailed': '侦测失败 (请检查 Key)',
    'resetAndReparseSelected': '重置并解析选取的',
    'abortParsing': '终止排队与解析',
    'queueStuckHint': '若长时间停滞，可能是云端伫列超时休眠。请圈选档案并点击上方「全部重新解析」改由本地强制处理。',
    'ultraMining': '深度挖掘 (Ultra-Mining)',
    'diagnoseReason': '诊断原因',
    'unitItems': '笔',
    'forceRefreshStats': '强制重新获取最新统计',
    'sizeLimitTooltip': '可手动输入要删除的容量设定',
    'diagTitle': '系统健康度与诊断报告',
    'diagEnvCheck': '环境配置检查',
    'diagQueueStatus': '背景伫列状态',
    'diagDeadlockDetect': '潜在阻塞侦测',
    'diagNoDeadlock': '未发现显著的背景死锁现象',
    'diagAnalysis': '诊断分析与建议',
    'diagFix': '立即解锁并重启伫列',
    'diagStalled': '已停滞:',
    'diagMinutes': '分钟',
    'diagStatus': '状态:',
    'pushingToQueue': '正在将档案推入云端解析伫列...',
    'close': '关闭',
    'apiQuotaWarning': '⚠️ API 额度即将耗尽！系统将持续运作至完全用尽为止。',
    'rpmLabel': 'RPM (每分钟):',
    'rpdLabel': 'RPD (今日):',
    'keyPoolLabel': '金钥池',
    'unitKeys': '把',
    'syncingHints': '同步建议事项中...',
    'modelLabel': 'Model:'
  },
  'en-US': {
...
If you have any suggestions or concerns regarding the process, please reply to this MAIL.`,
    ...
    'tabFreeMode': 'Free Mode',
    'tabPaidMode': 'Paid Mode',
    'proUnlocked': 'Pro Unlocked',
    'qstashTodayUsage': 'QStash Today Usage',
    ...
    'dayOfOfMonth': 'th',
    'remainingAbout': 'Remaining about',
    'unitDaysSuffix': ' days',
    'proQStashLimit': 'Pro QStash Limit',
    'proQStashLimitVal': '100,000+ calls / day',
    'proEgressLimit': 'Pro Egress Limit',
    'proEgressLimitVal': '250 GB / month',
    'proTimeoutLimit': 'Vercel Timeout Limit',
    'proTimeoutLimitVal': '300s (Pro Runtime)',
    'proAiPriority': 'AI Parse Priority',
    'proAiPriorityVal': 'Enterprise Quota',
    'execLimitLabel': 'Exec Limit',
    'aiModelLabel': 'AI Model',
    'detecting': 'Detecting...',
    'waitingForTask': 'Waiting for task',
    'detectionFailed': 'Detection failed (Check Key)',
    'resetAndReparseSelected': 'Reset & Reparse Selected',
    'abortParsing': 'Abort Queue & Parsing',
    'queueStuckHint': 'If stalled for a long time, the cloud queue might be dormant. Select files and click "Reparse All" above to force local processing.',
    'ultraMining': 'Ultra-Mining',
    'diagnoseReason': 'Diagnose',
    'unitItems': 'items',
    'forceRefreshStats': 'Force Refresh Stats',
    'sizeLimitTooltip': 'Manually enter the size limit for deletion',
    'diagTitle': 'System Health & Diagnostic Report',
    'diagEnvCheck': 'Environment Configuration Check',
    'diagQueueStatus': 'Background Queue Status',
    'diagDeadlockDetect': 'Potential Blocking Detection',
    'diagNoDeadlock': 'No significant background deadlocks found',
    'diagAnalysis': 'Diagnostic Analysis & Recommendations',
    'diagFix': 'Unlock & Restart Queue Now',
    'diagStalled': 'Stalled:',
    'diagMinutes': 'mins',
    'diagStatus': 'Status:',
    'pushingToQueue': 'Pushing files to cloud queue...',
    'close': 'Close',
    'apiQuotaWarning': '⚠️ API Quota nearly exhausted! System will continue until fully depleted.',
    'rpmLabel': 'RPM (Min):',
    'rpdLabel': 'RPD (Day):',
    'keyPoolLabel': 'Key Pool',
    'unitKeys': 'keys',
    'syncingHints': 'Syncing Hints...',
    'modelLabel': 'Model:'
  },
  'th-TH': {
...
หากคุณมีข้อเสนอแนะหรือข้อสงสัยเกี่ยวกับขั้นตอน โปรดตอบกลับอีเมลนี้`,
    ...
    'tabFreeMode': 'โหมดเวอร์ชันฟรี',
    'tabPaidMode': 'โหมดเวอร์ชันจ่ายเงิน',
    'proUnlocked': 'ปลดล็อก Pro แล้ว',
    'qstashTodayUsage': 'การใช้งาน QStash วันนี้',
    'nextResetIn': 'เวลาก่อนรีเซ็ตครั้งต่อไป:',
    'unitHours': 'ชั่วโมง',
    'unitMinutes': 'นาที',
    'monthlyEgress': 'การรับส่งข้อมูลสะสมในเดือนนี้ (Egress)',
    'cycleReset': 'รอบการรีเซ็ต:',
    'everyMonth': 'ทุกเดือนวันที่',
    'dayOfOfMonth': '', 
    'remainingAbout': 'เหลือประมาณ',
    'unitDaysSuffix': 'วัน',
    'proQStashLimit': 'ขีดจำกัด QStash รุ่น Pro',
    'proQStashLimitVal': '100,000+ ครั้ง / วัน',
    'proEgressLimit': 'ปริมาณ Egress รุ่น Pro',
    'proEgressLimitVal': '250 GB / เดือน',
    'proTimeoutLimit': 'ขีดจำกัดเวลา Vercel Timeout',
    'proTimeoutLimitVal': '300s (Pro Runtime)',
    'proAiPriority': 'ลำดับความสำคัญการวิเคราะห์ AI',
    'proAiPriorityVal': 'Enterprise Quota',
    'execLimitLabel': 'ขีดจำกัดการทำงาน',
    'aiModelLabel': 'รุ่น AI',
    'detecting': 'กำลังตรวจหา...',
    'waitingForTask': 'รอเริ่มภารกิจ',
    'detectionFailed': 'ตรวจหาล้มเหลว (โปรดตรวจสอบ Key)',
    'resetAndReparseSelected': 'รีเซ็ตและวิเคราะห์รายการที่เลือก',
    'abortParsing': 'ยกเลิกคิวและการวิเคราะห์',
    'queueStuckHint': 'หากหยุดนิ่งเป็นเวลานาน อาจเป็นเพราะคิวคลาวด์หมดเวลา โปรดเลือกไฟล์แล้วคลิก "วิเคราะห์ใหม่ทั้งหมด" ด้านบนเพื่อบังคับจัดการในเครื่อง',
    'ultraMining': 'การขุดข้อมูลเชิงลึก (Ultra-Mining)',
    'diagnoseReason': 'วินิจฉัยสาเหตุ',
    'unitItems': 'รายการ',
    'forceRefreshStats': 'บังคับรีเฟรชสถิติล่าสุด',
    'sizeLimitTooltip': 'ป้อนขนาดไฟล์ที่ต้องการลบด้วยตนเอง',
    'diagTitle': 'ระบบสุขภาพและการวินิจฉัย',
    'diagEnvCheck': 'ตรวจสอบการกำหนดค่าสภาพแวดล้อม',
    'diagQueueStatus': 'สถานะคิวพื้นหลัง',
    'diagDeadlockDetect': 'การตรวจจับการปิดกั้นที่อาจเกิดขึ้น',
    'diagNoDeadlock': 'ไม่พบปรากฏการณ์การปิดกั้นพื้นหลังที่สำคัญ',
    'diagAnalysis': 'การวิเคราะห์และคำแนะนำการวินิจฉัย',
    'diagFix': 'ปลดล็อกและรีสตาร์ทคิวทันที',
    'diagStalled': 'หยุดนิ่ง:',
    'diagMinutes': 'นาที',
    'diagStatus': 'สถานะ:',
    'pushingToQueue': 'กำลังส่งไฟล์เข้าคิวคลาวด์...',
    'close': 'ปิด',
    'apiQuotaWarning': '⚠️ โควตา API ใกล้จะหมดแล้ว! ระบบจะทำงานต่อไปจนกว่าจะหมด',
    'rpmLabel': 'RPM (ต่อนาที):',
    'rpdLabel': 'RPD (ต่อวัน):',
    'keyPoolLabel': 'พูลคีย์',
    'unitKeys': 'คีย์',
    'syncingHints': 'กำลังซิงค์คำแนะนำ...',
    'modelLabel': 'รุ่น:'
  }
};
