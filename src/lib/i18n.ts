export const translations: Record<string, any> = {
  'zh-TW': {
    ...
    'noHints': '暫無 AI 建議',
    'retryTranslation': '重試轉譯',
    'forceRetryTranslation': '內容不對？強制重新轉譯',
...
如於執行流程有任何建議或疑慮之處，煩請回覆此 MAIL。`,
  ...
  'zh-CN': {
    ...
    'noHints': '暂无 AI 建议',
    'retryTranslation': '重试转译',
    'forceRetryTranslation': '内容不对？强制重新转译',
...
如于执行流程有任何建议或疑慮之处，烦请回复此 MAIL。`,
  ...
  'en-US': {
    ...
    'forceRetryTranslation': 'Wrong content? Force re-translate',
...
If you have any suggestions or concerns regarding the process, please reply to this MAIL.`,
  ...
  'th-TH': {
    ...
    'dept_Production': 'ฝ่ายผลิต',
    'dept_Engineering': 'ฝ่ายวิศวกรรม',
    'dept_Safety': 'ฝ่ายความปลอดภัย',
    'dept_Equipment': 'ฝ่ายอุปกรณ์',
    'dept_Quality': 'ฝ่ายประกันคุณภาพ',
    'dept_RD': 'ฝ่ายวิจัยและพัฒนา',
    'dept_PRD': 'PRD',
    'dept_Purchasing': 'ฝ่ายจัดซื้อ',
    ...
    'forceRetryTranslation': 'เนื้อหาไม่ถูกต้อง? บังคับแปลใหม่',
